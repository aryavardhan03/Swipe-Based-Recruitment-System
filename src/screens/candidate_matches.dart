...
class CandidateMatches extends StatelessWidget {
  const CandidateMatches({super.key});
              ...
              Expanded(
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    print("Candidate Matches Count: ${matches.length}");
        ...
        children: [
          ...
          Row(
            children: [
              const Icon(
                Icons.work,
                color: Color.fromARGB(255, 107, 170, 187),
                size: 33,
              ),
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              minHeight: 6,
              backgroundColor: const Color.fromARGB(255, 172, 176, 178),
              valueColor:
